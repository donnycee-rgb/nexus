...
function ModalSearch({ id, searchId, modalOpen, setModalOpen }) {
  ...
  const recentSearches = [
    { label: 'Spring Launch Reel', sub: 'Post · Instagram' },
    { label: 'BTS Carousel', sub: 'Post · LinkedIn' },
    { label: 'Aurora Labs engagement stats', sub: 'Analytics' },
    { label: 'Jordan M. inbox thread', sub: 'Inbox · Instagram' },
    { label: 'Scheduled posts this week', sub: 'Scheduler' },
  ];

  const recentPages = [
    { label: 'Analytics', sub: 'Aurora Labs workspace' },
    { label: 'Inbox', sub: 'Conversation / Jordan M.' },
    { label: 'Scheduler', sub: 'Upcoming posts' },
  ];
  ...
  return (
    <>
      ...
      >
        <div ref={modalContent} className="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg">
          <form className="border-b border-gray-200 dark:border-gray-700/60">
            <div className="relative">
              ...
              <input
                ...
                type="search"
                placeholder="Search posts, analytics, inbox…"
                ref={searchInput}
              />
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                {recentSearches.map((item) => (
                  <li key={item.label}>
                    <Link
                      className="flex items-center p-2 text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700/20 rounded-lg gap-3"
                      to="#0"
                    ...
                    >
                      ...
                      <span>
                        ...
                        <span className="text-gray-500 dark:text-gray-400"> — {item.sub}</span>
                      </span>
                    </Link>
                  </li>
                ))}
