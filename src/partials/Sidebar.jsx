    ...
    <div className="min-w-fit">
      ...
      >
        ...
        {activeWorkspace && (
          <div className="mb-4">
            <div
              className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-700/60 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition"
            ...
            >
              ...
              <div className="min-w-0 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 uppercase font-mono truncate">
                  {activeWorkspace.role}
                </p>
              </div>
              <svg className="shrink-0 ml-auto fill-current text-gray-400 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200" width="12" height="12" viewBox="0 0 12 12">
                <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z"/>
              </svg>
            </div>

            {/* Workspace switcher — other workspaces */}
            {workspaces.filter((w) => w.id !== activeWorkspace.id).length > 0 && (
              <div className="mt-1 pl-2 lg:hidden lg:sidebar-expanded:block 2xl:block">
                {workspaces.filter((w) => w.id !== activeWorkspace.id).map((ws) => (
                  <button
                    key={ws.id}
                    onClick={() => { setWorkspace(ws); navigate('/'); }}
                    className="flex items-center gap-2 w-full text-left px-2 py-1.5 rounded text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate"
                  >
                    <div className="w-4 h-4 rounded-full shrink-0" style={{ backgroundColor: ws.color }} />
                    {ws.company}
                  </button>
                ))}
              </div>
        ...
        <div className="mb-4">
          <NavLink
            to="/compose"
            className="btn w-full bg-violet-500 hover:bg-violet-600 text-white flex items-center justify-center gap-2 lg:justify-center"
          >
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
              <span className="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Content</span>
            </h3>
            <ul className="mt-3">
              <NavItem
                to="/compose"
              ...
              <NavItem
                ...
                icon={
                  <svg width="16" height="16" viewBox="0 0 16 16" className="fill-current">
                    <path d="M14 2H2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1ZM3 4h4v4H3V4Zm0 6h10v1H3v-1Zm10-2H8V7h5v1ZM8 5h5v1H8V5Z"/>
                  </svg>
                }
              />
              <NavItem
          ...
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
              <span className="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Engage</span>
            </h3>
            <ul className="mt-3">
              <NavItem
                to="/inbox"
