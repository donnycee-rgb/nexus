      ...
      <div className="px-5 pt-4 pb-1">
        <header className="flex justify-between items-center mb-1">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: '#E1306C' }}>
            ...
            <h2 className="text-sm font-semibold text-gray-800 dark:text-gray-100">Instagram</h2>
          </div>
        </header>
